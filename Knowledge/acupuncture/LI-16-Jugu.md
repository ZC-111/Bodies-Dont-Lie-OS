...
| Evidence Level | derived — source-verified (Deadman pp. 117–118); cross-source: Bencaodian |
...
Perpendicular or oblique insertion 0.5 to 1 cun. **Caution: deep medial insertion carries a risk of pneumothorax, particularly in thin patients.**
...
- *A Manual of Acupuncture* (Deadman), pp. 117–118 — read directly from source (column-aware)
- Cross-source: Bencaodian (巨骨 Jugu)
...
- Previous: [LI-15 Jianyu](LI-15-Jianyu.md) · Next: [LI-17 Tianding](LI-17-Tianding.md)
