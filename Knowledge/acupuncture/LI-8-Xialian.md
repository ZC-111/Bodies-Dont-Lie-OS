...
| Chinese | 下廉 |
| Point class | — |
| Evidence Level | derived — source-verified (Deadman p. 110); cross-source: Bencaodian |
| Last Verified | 2026-09-04 |

## Location

On the radial side of the forearm, 4 cun distal to Quchi LI-11, on the line connecting Quchi LI-11 with Yangxi LI-5.
...
- *A Manual of Acupuncture* (Deadman), p. 110 — read directly from source (column-aware)
- Cross-source: Bencaodian (下廉 Xialian)
...
- Previous: [LI-7 Wenliu](LI-7-Wenliu.md) · Next: [LI-9 Shanglian](LI-9-Shanglian.md)
